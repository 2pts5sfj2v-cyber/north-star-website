...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for North Star Trading LLC.",
};

const sections: { title: string; body: string; id?: string }[] = [
  {
    title: "1. Acceptance of Terms",
    body: 'By accessing this website or engaging North Star Trading LLC ("we," "our," or "us"), you agree to these Terms of Service. If you do not agree, please do not use our website or services.',
  },
  {
    title: "2. Services",
  ...
  },
  {
    ...
    body: "These Terms are governed by the laws of the State of [State of Registration], United States, without regard to conflict-of-law principles.",
  },
  {
