...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Meet the Veteran Collective behind North Star Trading LLC — senior operators from Amazon, Shopify, TikTok Shop, Maersk, and Thrasio.",
};
    ...
    <>
      <section className="relative overflow-hidden pb-14 pt-32 lg:pt-40">
        ...
        <div className="container-x relative max-w-3xl">
          <span className="eyebrow">About North Star Trading</span>
          ...
          <p className="mt-6 text-lg leading-relaxed text-slate-400">
            North Star Trading LLC is a boutique advisory and execution
      ...
      <section className="container-x py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <SectionHeading
            eyebrow="Our story"
            title="Guided by the North Star"
          />
          <div className="space-y-4 leading-relaxed text-slate-400">
            <p>
              We started North Star after years on the inside — running
