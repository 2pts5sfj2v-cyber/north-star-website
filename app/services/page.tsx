...
export const metadata: Metadata = {
  ...
  description:
    "Explore North Star Trading's fixed-price service catalog across market entry, store operations, performance marketing, supply chain, brand, and risk management.",
};
