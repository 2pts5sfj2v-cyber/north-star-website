...
export const metadata: Metadata = {
  ...
  description:
    "Refund and cancellation policy for North Star Trading LLC advisory and execution services.",
};

const sections = [
  {
    title: "1. Overview",
    body: "This Refund & Cancellation Policy applies to all advisory and execution services purchased from North Star Trading LLC. It explains when refunds are available, how to cancel an engagement, and how disputes are handled.",
  },
  {
    title: "2. Services & Physical Goods",
    body: "North Star Trading LLC sells consulting and advisory services only. We do not sell physical goods, so no product return (Return) policy applies.",
  },
  {
